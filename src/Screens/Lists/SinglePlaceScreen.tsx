    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.bottomBar}>
          ...
          <View style={styles.rowSB}>
            <Text style={styles.address}>{place.address_street}. {place.address_city}, {place.address_state} {place.address_zipcode}</Text>
          </View>
          <View style={styles.rowSB}>
      ...
      <View style={styles.contentList}>
        ...
        <Modal
          ...
          visible={addComment}
        >
          <PlaceAddComment grabPlaceComments={grabPlaceComments} place={place} setAddComment={setAddComment} addComment={addComment}/>
        </Modal>
      </View>
    </View>
  )
